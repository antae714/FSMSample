...
USTRUCT()
struct FINITESTATEMACHINEEDITOR_API FFSMGraphSchemaAction : public FEdGraphSchemaAction
{
 ...
 */
UCLASS()
class FINITESTATEMACHINEEDITOR_API UFSMGraphSchema : public UEdGraphSchema
{
	GENERATED_BODY()
public:

	// Begin UEdGraphSchema Overrides
...
UCLASS()
class FINITESTATEMACHINEEDITOR_API UFSMGraphSchema_K2 : public UEdGraphSchema_K2
{
	GENERATED_BODY()
public:
	virtual const FPinConnectionResponse CanCreateConnection(const UEdGraphPin* A, const UEdGraphPin* B) const override;
