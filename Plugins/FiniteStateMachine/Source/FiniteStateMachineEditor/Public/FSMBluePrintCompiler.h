 ...
 * 
 */
class FINITESTATEMACHINEEDITOR_API FFSMBlueprintCompiler : public IBlueprintCompiler
{
	// Begin IBlueprintCompiler Implementation
	...
	// ~End IBlueprintCompiler Implementation
};


class FINITESTATEMACHINEEDITOR_API FFSMKismetCompilerContext : public FKismetCompilerContext
{
